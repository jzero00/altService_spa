					...
					<div class="card-body">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-4">
									<input type="text" class="form-control" name="menu_ordr">
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								...
								<div class="col-4">
									<input type="text" class="form-control" name="menu_nm">
								</div>
								<div class="col-2">
									<label for="upper_menu_no" class="col-form-label">상위메뉴No *</label>
								</div>
								<div class="col-4 input-group">
									<input type="text" class="form-control" name="upper_menu_no">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-4">
									<input type="text" class="form-control" name="relate_image_nm">
								</div>
								<div class="col-2">
									<label for="relate_image_path" class="col-form-label">관련이미지경로 *</label>
								</div>
								<div class="col-4">
									<input type="text" class="form-control" name="relate_image_path">
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								...
								<div class="col-10">
									<textarea class="form-control" rows="3" name="menu_dc"></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-3">
								<div>
									<button type="button" class="btn bg-gradient-primary" style="margin-right: 10px;" onclick="registMenu(); return false;">등록</button>
